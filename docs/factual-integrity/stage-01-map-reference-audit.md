...
## Аудит map routes (closure pass 3, после `9155b62`)

### Правило

В публичный payload маршрутов попадают только stops из allowlist этапа 1. Маршруты целиком удаляются, если после очистки не остаётся смысла или все stops неподтверждены.

### Allowlist stops (этап 1)

| Stop | Адрес | Координаты | Источник | Статус |
|------|-------|------------|----------|--------|
| Государственный музей-заповедник А. С. Пушкина «Михайловское» | бульвар им. С. С. Гейченко, 1 | 57.0234195, 28.9307908 | pushkinland.ru + OSM | VERIFIED_PRIMARY / OPEN_DATA_ONLY |
| Свято-Успенский Святогорский мужской монастырь | ул. Пушкинская, 1 | 57.0224228, 28.9200652 | svyatogorskiy-monastery.ru + OSM | VERIFIED_PRIMARY / OPEN_DATA_ONLY |

### Удалённые маршруты (весь route)

| route id | Причина |
|----------|---------|
| trigorskoe-petrovskoe | все stops UNVERIFIED |
| mikhailovskoe-full | парковка, усадьба UNVERIFIED |
| village-walk | кафе, магазины UNVERIFIED |
| evening-pushkin | кафе, площадь UNVERIFIED |
| family-day | парковка, магазин, аптека UNVERIFIED |
| nature-walk | парковка, усадьба UNVERIFIED |
| from-bus | автовокзал UNVERIFIED |
| useful-village | магазины, аптека, почта, банк UNVERIFIED |
| winter-pushkin | усадьба, кафе UNVERIFIED |

### Удалённые stops (были в опубликованных маршрутах)

| Stop | Статус | Причина удаления |
|------|--------|------------------|
| Кафе «Пушкинъ» | UNVERIFIED | нет первичного источника |
| Пятёрочка | UNVERIFIED | нет store locator |
| Магнит | UNVERIFIED | нет store locator |
| Аптека-А | UNVERIFIED | агрегатор |
| Почта России | UNVERIFIED | не проверена |
| Сбербанк (банкомат) | UNVERIFIED | не store locator |
| Автовокзал Пушкинские Горы | PLACEHOLDER | нет источника |
| Парковка «У Трёх Сосен» | UNVERIFIED | нет источника |
| Усадьба «Михайловское» (село) | CONFLICTING | не НКЦ, coords не verified |
| Усадьба «Тригорское» | UNVERIFIED | нет источника |
| Усадьба «Петровское» | UNVERIFIED | нет источника |
| Площадь Ленина | UNVERIFIED | нет первичного источника |
| Касса музея-заповедника (краткое имя) | заменено | → официальное имя музея |

### Оставшиеся публичные маршруты

| route id | stops | description |
|----------|-------|-------------|
| pushkin-classic | музей → монастырь | нейтральное, без «лавра» |
| pilgrim | монастырь → музей | нейтральное, без «лавра» |

Длительность маршрутов заменена на «—» (не утверждается как факт).

### Hotlines: удаление 911

- Было: `note: "112 или 911 с мобильного"`
- Стало: `note: "Бесплатно с мобильного и стационарного телефона"`
- Причина: для РФ официально подтверждены 112, 101, 102, 103, 104 (МЧС/гос. регулирование единого номера 112). 911 — номер США, не рекомендуется.

### Официальный источник номера 112

Единый номер экстренных служб **112** в РФ установлен федеральным регулированием (в т.ч. постановления Правительства РФ о системе вызова экстренных оперативных служб). Номера 101–104 — прямые линии экстренных служб, сохранённые параллельно с 112.

### Cannot be verified (маршруты)

- Время прохождения любого маршрута.
- Порядок посещения как «рекомендованный» маршрут.
- Все удалённые stops из таблицы выше до отдельной первичной верификации на этапе 2+.
