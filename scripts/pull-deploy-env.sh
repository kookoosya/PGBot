...
REMOTE_KEYS=(
  VK_GROUP_TOKEN VK_GROUP_ID VK_GROUP_URL VK_EVENTS_TOKEN
  VK_CONFIRMATION_CODE VK_SECRET_KEY
  TIMEPAD_API_TOKEN PROCULTURE_API_KEY
  POLLINATIONS_API_KEY OPENROUTER_API_KEY GEMINI_API_KEY OPENAI_API_KEY
  KINOPOISK_API_TOKEN
)
