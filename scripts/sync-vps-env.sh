...
_set_env_var AI_TRIAL_DAILY_LIMIT "${AI_TRIAL_DAILY_LIMIT:-10}"
_set_env_var AI_PRO_DAILY_LIMIT "${AI_PRO_DAILY_LIMIT:-50}"
_set_env_var AI_MAX_DAILY_LIMIT "${AI_MAX_DAILY_LIMIT:-50}"
