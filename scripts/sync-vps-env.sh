...
_set_env_var PAYMENT_CARD_NUMBER "${PAYMENT_CARD_NUMBER:-}"
_set_env_var PAYMENT_PHONE "${PAYMENT_PHONE:-}"
_set_env_var BANK_IMAP_HOST "${BANK_IMAP_HOST:-}"
_set_env_var BANK_IMAP_USER "${BANK_IMAP_USER:-}"
_set_env_var BANK_IMAP_PASSWORD "${BANK_IMAP_PASSWORD:-}"
