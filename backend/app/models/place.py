...
class Place(Base):
    ...
    yandex_id: Mapped[str | None] = mapped_column(String(50), unique=True, index=True)
    yandex_url: Mapped[str | None] = mapped_column(String(500))
    external_source: Mapped[str | None] = mapped_column(String(30))
    external_rating: Mapped[float] = mapped_column(Float, default=0.0)
    external_review_count: Mapped[int] = mapped_column(Integer, default=0)
