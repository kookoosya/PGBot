...
from app.services.weather import WeatherFetchError, format_weather_digest_lines, get_weather
...
async def send_daily_digest(db: AsyncSession) -> int:
    """Отправить дайджест подписчикам (раз в сутки в DIGEST_HOUR_UTC)."""
