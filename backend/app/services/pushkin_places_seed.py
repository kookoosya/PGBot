...
VILLAGE_PLACES: list[tuple] = [
    ...
    (
        "М.Косметик", PlaceCategory.BEAUTY, 57.0261, 28.9112,
        "ул. Ленина, 42", "8-800-200-90-02", "ежедневно до 22:00", 0, 0,
        "https://magnit.ru", "Магазин косметики в здании Магнит",
    ),
    ...
    (
        ...
        "ул. Новоржевская, 30", "+7 (81146) 2-05-05", "06:00–22:00", 0, 0,
        None, None,
    ),
    ...
    # —— Кафе, школа ——
    (
        "НКЦ «Пушкинские Горы»", PlaceCategory.CULTURE, 57.0273, 28.9095,
        "б-р им. С.С. Гейченко, 1", "+7 (81146) 2-23-21",
        "выставки и мероприятия музея-заповедника", 0, 0,
        "https://pushkinland.ru", "Научно-культурный центр на въезде в посёлок",
    ),
    (
        "Кафе «Пушкинъ»", PlaceCategory.CAFE, 57.0267, 28.9112,
...
TAXI_SEED = [
    (
        ...
        "+7 (921) 000-28-28",
        "+7 (900) 997-90-00",
        "Местная служба 24/7, посадка от 150 ₽",
        True,
        0,
        150,
        1,
    ...
    (
        "Грузоперевозки до 1,5 т",
        "+7 (911) 354-70-24",
        None,
        "Дмитрий — перевозка мебели и стройматериалов, цена по договорённости",
        False,
        0,
        None,
        3,
