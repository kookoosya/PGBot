...
VILLAGE_PLACES: list[tuple] = [
    ...
    ("Гостиница «Пушкиногорская»", PlaceCategory.HOTEL, 57.0278, 28.9105, "ул. Красноармейская, 18", "+7 (81146) 2-13-50", "круглосуточно", 0, 0),
    ("Гостевой дом «Михайловское»", PlaceCategory.HOTEL, 57.0282, 28.9075, "с. Михайловское", "+7 (81146) 2-17-20", "круглосуточно", 0, 0),
