...
const AdminVkModeration = lazy(() => import("./pages/AdminVkModeration").then((m) => ({ default: m.AdminVkModeration })));
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="vk-moderation" element={<Lazy><AdminVkModeration /></Lazy>} />
