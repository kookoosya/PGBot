  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "🪶 Привет! Бесплатно — 10 сообщений или картинок в день. После входа — 7 дней пробного доступа. Платные тарифы — во вкладке «Тарифы».",
    },
  ]);
  ...
  return (
    <div className="page-section max-w-3xl ai-page">
      ...
      <div className="ai-limits-info" role="note">
        ...
        <p>
          <strong>ИИ Pro</strong> — до 50 сообщений в сутки. <strong>Pro+</strong> — до 100.
          Оплата переводом на карту портала, доступ включает администратор.
        </p>
