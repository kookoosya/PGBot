...
export const LANDING_VERSES: PushkinVerse[] = [
  {
    text: "«Вновь я посетил\nТот уголок земли, где вольной жизнью\nПровёл два года незаметных...»",
    source: "«Я вновь посетил...»",
  },
  {
...
export const PHOTO_VERSES: Record<string, string> = {
  Михайловское: "«Вновь я посетил тот уголок земли...»",
...
export const VILLAGE_PHOTOS = [
  ...
  },
  {
    ...
    caption:
      "Научно-культурный центр музея-заповедника — белое здание с колоннами на въезде в посёлок, выставки и мероприятия.",
    url: "/images/gallery/nkc.jpg",
    webp: "/images/gallery/nkc.webp",
    credit: "Wikimedia Commons, 2013",
  },
  {
